...
struct bookk book[N]=
{{"1自传","1","自动化学院出版社","330-7-250-25025-9",3,2,"2024.5.17",'0'}					//书籍定义模板
,{"C语言程序设计","1","广东工业大学出版社","978-7-302-22204-0",3,2,"2024.6.15",'0'}};				//操作在程序或文件中进行 
...
void list_yk()													//游客模式的书籍清单页,用于回到游客模式主菜单,避免权限泄露 
{
	int i;
	system("cls");
	count();
